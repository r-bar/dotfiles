# Generated by Powerlevel10k configuration wizard on 2019-10-26 at 00:54 PDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 00796.
# Wizard options: powerline, lean, time, 2 lines, disconnected, compact, concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      asdf                    # tool versions from asdf version manager (https://github.com/asdf-vm/asdf)
      ...
      toolbox                 # toolbox container indicator (https://github.com/containers/toolbox)
