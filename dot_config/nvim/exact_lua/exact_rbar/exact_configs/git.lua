...
function M.packages(use)
	...
	use({
		...
		config = function()
			...
			end, { desc = "GitSigns: show line blame" })
			map("n", "<leader>hb", gitsigns.toggle_current_line_blame, { desc = "GisSigns: toggle line blame" })
			map(
				"n",
				"<leader>hd",
				gitsigns.diffthis,
				{ desc = "GitSigns: perform a vimdiff on this file against the index" }
			)
			map("n", "<leader>hD", function()
				gitsigns.diffthis("~")
			end, { desc = "GitSigns: perform a vimdiff on this file against the last commit" })
