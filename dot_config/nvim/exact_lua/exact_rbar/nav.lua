...
function M.packages(use)
  ...
  use {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>1", function() ui.nav_file(1) end, { noremap = true, desc = "Harpoon show file 1" })
      vim.keymap.set("n", "<leader>2", function() ui.nav_file(2) end, { noremap = true, desc = "Harpoon show file 2" })
      vim.keymap.set("n", "<leader>3", function() ui.nav_file(3) end, { noremap = true, desc = "Harpoon show file 3" })
      vim.keymap.set("n", "<leader>4", function() ui.nav_file(4) end, { noremap = true, desc = "Harpoon show file 4" })

      vim.keymap.set("n", "<A-1>", function() ui.nav_file(1) end, { noremap = true, desc = "Harpoon show file 1" })
      vim.keymap.set("n", "<A-2>", function() ui.nav_file(2) end, { noremap = true, desc = "Harpoon show file 2" })
      vim.keymap.set("n", "<A-3>", function() ui.nav_file(3) end, { noremap = true, desc = "Harpoon show file 3" })
      vim.keymap.set("n", "<A-4>", function() ui.nav_file(4) end, { noremap = true, desc = "Harpoon show file 4" })
    end,
  }
